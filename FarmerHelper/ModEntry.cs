...
namespace FarmerHelper
{
    ...
    public partial class ModEntry : Mod
    {
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            harmony.Patch(
               original: AccessTools.Method(typeof(GameLocation), nameof(GameLocation.createQuestionDialogue), new System.Type[] { typeof(string), typeof(Response[]), typeof(string), typeof(StardewValley.Object) }),
        ...
        private static Season[] seasons = new Season[] { Season.Spring, Season.Summer, Season.Fall, Season.Winter };
